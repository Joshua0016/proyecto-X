...
namespace Backend.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Use the correct model type name 'rol' (lowercase) to match model class
            ...
            // Use the correct model type name 'usuario' and correct member names (lowercase) to match model class
            modelBuilder.Entity<usuario>(entity =>
            {
                ...
                entity.Property(e => e.email)
                    .HasMaxLength(150)
                    .HasColumnName("email");
                // Mapear a timestamptz para DateTimeOffset
                ...
                // navigation property names in model are lowercase: id_rolNavigation and role collection 'usuarios'
